...
export default function Button(props: Props) {
    const { disabled, label, onClick, button_style } = props;
    ...
    const textCn = cn('text-sm font-light font-mono text-white', {
        'text-gray-900': button_style === ButtonStyle.Secondary,
    });

    return (
        <div>
            <button disabled={disabled} className={buttonCn} onClick={onClick}>
